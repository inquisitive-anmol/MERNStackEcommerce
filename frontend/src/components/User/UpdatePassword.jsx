...
const UpdatePassword = () => {
  ...
  return (
    ...
    <div className="form bg-white/70 w-[30%] h-[80%] rounded-xl flex flex-col items-center justify-start pt-10">
      ...
      <form action="" className="w-full flex justify-center mt-10 px-7" onSubmit={updatePasswordSubmit}>
        <div className="w-full email flex flex-col gap-1 w-70%">
          ...
          />
          <label htmlFor="confirm-password" className="font-semibold mt-2">
            Confirm Password
          </label>
          <input
            type="text"
          ...
          <div className="cta">
            <button type="submit" className="w-full h-full bg-accentColor rounded-xl mt-3 hover:bg-[#FF3C00] p-1.5 font-semibold text-lg text-white" >
              Change
            </button>
          </div>
